    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-2xl mx-auto px-5 py-10 prose prose-sm">
        ...
        {[
          ...
          {
            title: "2. 収集する情報",
            body: "本アプリ・Webサービスは、外部サーバーへ個人情報を送信・収集しません。デバイス上またはブラウザのLocalStorageに保存されるデータは、学習の進捗状況・診断結果・スコアのみです。これらは外部に送信されることはありません。例外として、アプリ・Webサービスでユーザーが任意で送信する「問題へのフィードバック」（意見の種類とコメント）は、内容改善の目的でのみサーバーに保存されます。フィードバックに氏名・連絡先等の個人情報は入力しないでください。",
          },
          {
            title: "3. 第三者への情報提供",
